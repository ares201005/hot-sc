...
do i=100, 500
  omega = dble(i)*1.d-2
  call dielectric(3,'Au',omega,epsilonw)
  ztmp = (epsilonw-1)/(epsilonw+2) - 1.d0
  write(6,'(f9.3,4e15.6)') omega, epsilonw,ztmp
enddo
...
implicit none
complex*16, parameter :: cunity=dcmplx(1.d0,0.d0)
complex*16, parameter :: czero=dcmplx(0.d0,0.d0)
complex*16, parameter :: eye=dcmplx(0.d0,1.d0)
!
